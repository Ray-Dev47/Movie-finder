<template>
  <div>
    <div class="max-w-6xl bg-yellow-300 dark:bg-yellow-900 mx-auto">
      <!-- main -->
      <div class="mt-60 text-center">
        ...
        <!-- movie posters -->
        <div class="mt-36">
          <div class="font-bold dark:text-white text-2xl sm:text-4xl mb-10">
            New Releases
          </div>
        </div>
      </div>
...
export default {
  ...
  methods: {
    ...
    //     const star = array[rate];
    //     movie.rate= Math.ceil(movie.vote-average/2);
