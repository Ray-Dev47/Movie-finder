    ...
    <div>
        ...
        <div class="flex   sm:max-w-xl w-auto sm:mt-10 sm:mx-40 ">
			<div class="flex flex-col pb-20">
					<div class="">
						<div class="font-bold justify-items-end text-2xl sm:text-4xl mb-3">Godzilla vs. Kong</div>
						<div class="flex">
							...
							<div class="flex font-bold text-gray-500">. 2021</div>
						</div>
        ...
        <!-- <div class=" mx-auto mb-56">
			<div class="flex">
				<img
					...
					class="sm:w-full absolute sm:h-screen object-fill top-0"
					alt=""
				/>
			</div>
		</div>
		...
		<div>
			<div class="max-w-5xl mx-60 mb-36">
				<img
					src="@/assets/img/img-10.jpg"
					class="w-64 h-80 top-80 mb-48 ml-6 relative"
					alt=""
				/>

				<div class="grid-cols-2 ml-96 pb-20">
					<div class="flex flex-col">
						<div class="font-bold mt-24 text-4xl mb-3">Godzilla vs. Kong</div>
						<div class="flex">
							<div class="mr-3 text-lg text-red-500">
								<i class="fas fa-star"></i>
								<i class="fas fa-star"></i>
								<i class="fas fa-star"></i>
								<i class="fas fa-star"></i>
						...
						<div class="text-lg text-gray-600 font-bold my-6">
							In a time when monsters walk the Earth, humanity’s fight for its
							future sets Godzilla and Kong on a collision course that will see
							the two most powerful forces of nature on the planet collide in a
							spectacular battle for the ages.
